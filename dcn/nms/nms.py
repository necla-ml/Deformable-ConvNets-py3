...
from .cpu import cpu_nms, cpu_soft_nms
from .cuda import gpu_nms


def cpu_softnms_wrapper(sigma=0.6, Nt=0.3, method=1):
    def _nms(dets, threshold=0.001, method=1):
        return cpu_soft_nms(np.ascontiguousarray(dets, dtype=np.float32),
